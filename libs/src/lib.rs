...
// NOT in documentation, but needed because Godot editor will not find MyEditorSingleton otherwise...
#[gdextension]
unsafe impl ExtensionLibrary for MyEditorSingleton {}
...
unsafe impl ExtensionLibrary for MyExtension {
    fn on_level_init(level: InitLevel) {
        ...
        if level == InitLevel::Scene {
            ...
            Engine::singleton()
                .register_singleton(singleton_struct, MyEditorSingleton::new_alloc().upcast());
        }
    }
